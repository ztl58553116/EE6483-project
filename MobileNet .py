...
# 设置代理环境变量
os.environ['http_proxy'] = 'http://turbo.gpushare.com:30000'
os.environ['https_proxy'] = 'http://turbo.gpushare.com:30000' 
...
batch_size = 128
train_dataset = datasets.ImageFolder(root='./expanded_datasets/train', transform=transform_train_img)
val_dataset = datasets.ImageFolder(root='./expanded_datasets/val', transform=transform_val_img)
...
model.classifier = torch.nn.Sequential(
    ...
    torch.nn.Linear(input_features, 2)
)
